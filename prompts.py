...
def page_translate_prompt(blocks: list[dict]) -> str:
    ...
    return (
        ...
        "   (or give: Chinese (English)). Only do this inside a paragraph — never append\n"
        "   the English original to a heading, caption or short label, where it doubles\n"
        "   the length and no longer fits the layout.\n"
        " - Leave statistical and mathematical notation exactly as it is. Lone letters and\n"
        "   symbols such as F, p, n, N, M, SD, df, t, r, #, %, χ2 are table headings, not\n"
        "   English words: F is the F statistic, p is a p value, # is a count. If a block\n"
        "   is nothing but such a symbol, return it unchanged.\n"
